...
def build_model(config: BaselineConfig, X_d_scaler: StandardScaler | None, **kwargs):
    ...
    print(kwargs)
    if "modded_bond_message_passing" in kwargs:
        mp = kwargs["modded_bond_message_passing"](
            d_h=config.mp_d_h,
...
def train_func(
    ...
    **kwargs,
    ...
    model = build_model(config, X_d_scaler, **kwargs)
